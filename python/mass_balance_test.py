...
# prior_dir = '/n/holyscratch01/jacob_lab/hnesser/TROPOMI_inversion/jacobian_runs/TROPOMI_inversion_0000_final/OutputDir'
# pert_dir = '/n/holyscratch01/jacob_lab/hnesser/TROPOMI_inversion/jacobian_runs/TROPOMI_inversion_0000_mb_sf/OutputDir'
...
# ## ---------------------------------------------------------------------##
# pert_files = glob.glob(f'{pert_dir}/{s.year:04d}01??_GCtoTROPOMI.pkl')
...
print((emis['EmisCH4_Evecs']/emis['EmisCH4_Total']).values)
